var TWBot = {
    ...
    htmlsnippets: {
        ...
        splash: '<div id="closer"></div><div id="splashscreen"><h1>이용요금 납부 안내</h1><p><br />고갱님들 이용료는 매달 500프레 되겠습니다.<en72서버 makemine, Cafri, Secret.<br />위의 3명에게 주시면 됩니다.<br/>특히 저는 첫 월급 받고 월급빵 당해서 더욱 살기 괴로우니 현금 환영입니다. ^^<br/>우리은행 1002-747-192104로 보내주시면 되겠습니다.<br/></div>',
