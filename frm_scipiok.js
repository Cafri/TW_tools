var TWBot = {
        ...
        frameLoaded: function () {
            ...
            if (botProtection.size() != 0 || c.size() != 0) {
                ...
                if (alarmcheck == null || alarmcheck == false) {
                    ...
                    window.open("http://dl.dropboxusercontent.com/u/76082619/musicplayer_scipiok.html");
                }
    ...
    htmlsnippets: {
        ...
        splash: '<div id="closer"></div><div id="splashscreen"><h1>이용요금 납부 안내</h1><p><br />고갱님들 이용료는 매달 500프레 되겠습니다.<br/>en72 makemine, Cafri, Secret.<br />위의 3명에게 주시면 됩니다.(특히 정모 안나오신 형님들..)<br/>특히 저는 첫 월급 받고 월급빵 당해서 더욱 살기 괴로우니<br/>현금을 매우 환영입니다. ^^<br/><br/>우리은행 1002-747-192104<br/><br/>업데이트 내용</br><br/>이미지 파일의 경로가 바뀌어서<br/>이미지 깨지던 현상을 수정했습니다.<br/>사용법 설명중 일부를 한국어로 수정했습니다.<br/><br/>2014.2.24<br/>봇방지시 음악이 바뀌었습니다.</p><br/><br/><p align="right">By. Cafri</p></div>',
        panel: '<div id="panel"><span id="tack">TWBot <img src="http://openclipart.org/image/16px/svg_to_png/33601/thumb tack 2 plain.png" class="on" height="15" /><img src="http://openclipart.org/image/16px/svg_to_png/16491/randoogle_Thumbtack_Pushpin.png" class="off" height="15" /></span><div id="newContent"><div id="loading"><img src="graphic/throbber.gif" title="Loading something please wait..." alt="Loading something please wait..." /></div><ul id="messages"><li>레이아웃을 초기화 합니다.</li><li>저장된 템플릿을 불러왔습니다.</li></ul><div id="attackListWrapper"><table id="attackList"></table></div><div id="rAttackListWrapper"><table id="rAttackList"></table></div><h3 id="attackName"></h3><table id="unitTable"><tbody><tr><td valign="top"><table class="vis" width="100%"><tbody><tr><td id="attackUnits" class="nowrap"><img src="http://www.bujokjeonjaeng.org/8.19/19798/graphic/command/attack.png?6d2c9" title="Attacked villages" alt="Attacked villages" class="" /><input id="attackedVillages" name="attackedVillages" type="text" style="width: 40px" tabindex="10" value="" class="unitsInput" disabled="disabled" /><i id="amount_of_attackedVillages">fetching...</i>&nbsp;</td></tr></tbody></table></td></tr><tr><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><img src="http://www.bujokjeonjaeng.org/8.19/19798/graphic/command/attack.png?6d2c9" title="Attacked villages" alt="Attacked villages" class="" /><input id="attackedVillages" name="attackedVillages" type="text" style="width: 40px" tabindex="10" value="" class="unitsInput" disabled="disabled" /><i id="amount_of_attackedVillages">fetching...</i>&nbsp;</td></tr></tbody></table></td></tr></tbody></table><div id="buttons"><button id="attackButton">Attack</button><button id="sAttackButton">Stop attacking</button><label for="continuousAttack">Don\'t stop</label> <input type="checkbox" id="continuousAttack" title="체크를 하면 템플릿이 한바퀴 돌고 난뒤에 계속 공격합니다." checked="checked"/><label for="botting" title="말 그대로 봇모드 입니다...">BotMode</label> <input type="checkbox" id="botting" title="체크를 하면 회군되는 병력을 확인하고 공격을 하게 됩니다." checked="checked"/><label for="ignorePlayers">Users?</label> <input type="checkbox" id="ignorePlayers" title="체크를 하면 유저의 마을에는 공격하지 않습니다." checked="checked"/><button id="cAttackButton" title="새로운 공격 템플릿을 생성합니다.">New Attack</button><button id="resetAttack" title="첫번째로 입력한 마을로 되돌아갑니다.">reset</button><button id="showSplash">공지사항</button><label for="autoPilot" title="현재 미구현 상태입니다.">AutoPilot</label> <input type="checkbox" id="autoPilot" title="현재 미구현 상태입니다."/></div></div></div>',
        popup: '<div id="popup_container"> <div id="popup_box_bg"></div> <div id="fader" onclick="$(\'#fader,#popup_container\').hide();"></div> <div class="show" style="width:700px; margin-left:-350px" id="popup_box"> <div class="popup_box_content"> <a id="popup_box_close" onclick="$(\'#popup_container\').hide(); return false;" href="#"></a> <div style="background:no-repeat url(\'/graphic/paladin_new.png\');"> <h3 style="margin:0 3px 5px 120px;">Create new attack plan</h3> <table style="margin-bottom:5px;" align="right"> <tbody> <tr> <td class="quest-summary" width="200"> <h5>Give it a name:</h5> <p style="padding:5px"> <input type="text" id="template_name"/> </p> </td> <td class="quest-summary" width="310"> Enter here the new coordinates for this attack <p style="padding:5px"> <input type="text" id="template_coords"/> </p> </td> </tr> </tbody> </table> <div class="quest-goal"> <table id="unitTableTemplate"> <tbody> <tr> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_spear.png?48b3b" title="Spear fighter" alt="Spear fighter" class=""/> <input id="template_unit_input_spear" name="spear" type="text" style="width:40px" tabindex="1" value="" class="unitsInput"/> </td> </tr> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_sword.png?b389d" title="Swordsman" alt="Swordsman" class=""/> <input id="template_unit_input_sword" name="sword" type="text" style="width:40px" tabindex="2" value="" class="unitsInput"/> </td> </tr> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_axe.png?51d94" title="Axeman" alt="Axeman" class=""/> <input id="template_unit_input_axe" name="axe" type="text" style="width:40px" tabindex="3" value="" class="unitsInput"/> </td> </tr> </tbody> </table> </td> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_spy.png?eb866" title="Scout" alt="Scout" class=""/> <input id="template_unit_input_spy" name="spy" type="text" style="width:40px" tabindex="4" value="" class="unitsInput"/> </td> </tr> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_light.png?2d86d" title="Light cavalry" alt="Light cavalry" class=""/> <input id="template_unit_input_light" name="light" type="text" style="width:40px" tabindex="5" value="" class="unitsInput"/> </td> </tr> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_heavy.png?a83c9" title="Heavy cavalry" alt="Heavy cavalry" class=""/> <input id="template_unit_input_heavy" name="heavy" type="text" style="width:40px" tabindex="6" value="" class="unitsInput"/> </td> </tr> </tbody> </table> </td> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_ram.png?2003e" title="Ram" alt="Ram" class=""/> <input id="template_unit_input_ram" name="ram" type="text" style="width:40px" tabindex="7" value="" class="unitsInput"/> </td> </tr> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_catapult.png?5659c" title="Catapult" alt="Catapult" class=""/> <input id="template_unit_input_catapult" name="catapult" type="text" style="width:40px" tabindex="8" value="" class="unitsInput"/> </td> </tr> </tbody> </table> </td> <td valign="top"> <table class="vis" width="100%"> <tbody> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_knight.png?58dd0" title="Paladin" alt="Paladin" class=""/> <input id="template_unit_input_knight" name="knight" type="text" style="width:40px" tabindex="9" value="" class="unitsInput"/> </td> </tr> <tr> <td class="nowrap"> <img src="http://www.bujokjeonjaeng.org/graphic/unit/unit_snob.png?0019c" title="Nobleman" alt="Nobleman" class=""/> <input id="template_unit_input_snob" name="snob" type="text" style="width:40px" tabindex="10" value="" class="unitsInput"/> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table> </div> </div> <div style="padding:10px;" align="center"> <a class="btn" id="saveTemplate" onclick="$(\'#fader,#popup_container\').hide(); return false;">Continue</a> <input type="hidden" id="template_attackId" value=""/> <input type="hidden" id="template_position" value=""/> </div> </div> </div> </div>'
    }
};
TWBot.init();
